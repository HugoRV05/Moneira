    ...
    <div className="container min-h-screen">
      ...
      <header className="py-8 flex justify-between items-center">
        ...
        <div className="w-14 h-14 bg-white neo-border neo-shadow overflow-hidden flex items-center justify-center">
          <img 
            src="/Gemini_Generated_Image_4geo1h4geo1h4geo.webp" 
            alt="Moneira Logo" 
      ...
      {!isFormOpen && (
        <Button 
          ...
          className="fixed bottom-8 right-4 w-16 h-16 rounded-none p-0 flex items-center justify-center neo-shadow-lg bg-black text-white"
        >
          <Plus size={32} />
        </Button>
      )}
